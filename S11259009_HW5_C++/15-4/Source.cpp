/*
* Test class of some sort of creatures and let them fight.
* Recording the result of each round and each match.
*/
#include <iostream>
#include <cstdlib>
#include <ctime>
...
void battleArena(Creature& c1, Creature& c2) {
    ...
    cout << "(Strength, Hitpoints)" << endl;
    cout << c1.getSpecies() << ": " << '(' << c1.getStrength() << ", " << c1.getHitpoints() << ')' << endl;
    cout << c2.getSpecies() << ": " << '(' << c2.getStrength() << ", " << c2.getHitpoints() << ')' << endl;
